...
<!-- Formulario de Pago -->
<form action="{{ route('make.payment') }}" method="POST" style="background-color: #1A2B4C;">
    @csrf
    ...
    <button type="submit" style="background-color: #1A2B4C;" class="btn btn-primary btn-block ">Pagar con Paypal</button>
</form>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-4 text-start">
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <p class="card-text">20.00 US$ único pago</p>
                <div class="row text-center border-top border-bottom  border-secondary m-5">
                    ...
                    <div class="p-1 col col-md-6"><h4 style="font-weight: bold;" class="card-title">20.00 US$</h4></div>
                </div>
                <div class="row m-5">
                    <button style="background-color: #1A2B4C;" class="btn btn-primary btn-block " type="button">Pagar con Paypal  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
