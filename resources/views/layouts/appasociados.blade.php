    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="/users">Pacientes</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/chat">Historial de Chats</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/doctorProfile">Editar Perfil</a>
                </li>
            </ul>

            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/logoutA">
